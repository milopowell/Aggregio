...
The application can be used at [this link](https://aggregio.onrender.com).
...
![Aggregio Home Page PNG](aggregio-example/aggregio_home_page.png)

Here is the homepage

`Aggregate creation`

![Aggregio Creation PNG](aggregio-example/aggregio_aggregate_creation.png)

Here is the page to create aggregates

`Aggregate naming`

![Aggregio Naming PNG](aggregio-example/aggregio_aggregate_naming.png)

Here is the page to name your new aggregate

`Aggregate viewing`

![Aggregio Map PNG](aggregio-example/aggregio_aggregate_map.png)
